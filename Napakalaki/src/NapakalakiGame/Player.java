...
public class Player {
    ...
    private BadConsequence pendingBadConsequence = new BadConsequence("nada", false);
...
BadConsequence. */
    public boolean validState() {
        if(hiddenTreasures.size() <= 4 
            &&  pendingBadConsequence.getSpecificHiddenTreasures().isEmpty()
            &&  pendingBadConsequence.getSpecificVisibleTreasures().isEmpty()
            &&  pendingBadConsequence.getnHiddenTreasures() == 0 
            &&  pendingBadConsequence.getnVisibleTreasures() == 0 ) 
       return true ; 
    return false ;  
