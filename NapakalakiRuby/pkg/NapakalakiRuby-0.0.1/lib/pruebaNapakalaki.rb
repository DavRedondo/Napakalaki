...
class PruebaNapakalaki 
  ...
  puts "\nLos monstruos que su mal rollo implica sólo pérdida de niveles son: "
  prueba = PierdeNivel()
  for monstruo in prueba
    puts monstruo
  end
  ...
  puts "\nLos monstruos que su mal rollo supone pérdida de una mano son: "
  prueba = PierdeTesoro(TreasureKind::ONEHAND)
  for monstruo in prueba
    puts monstruo
  end
  
  puts "\nLos monstruos que su mal rollo supone pérdida de armadura son: "
  prueba = PierdeTesoro(TreasureKind::ARMOR)
  for monstruo in prueba
    puts monstruo
  end
  
  puts "\nLos monstruos que su mal rollo supone pérdida de casco son: "
  prueba = PierdeTesoro(TreasureKind::HELMET)
  for monstruo in prueba
    puts monstruo
  end
  
  puts "\nLos monstruos que su mal rollo supone pérdida de zapatos son: "
  prueba = PierdeTesoro(TreasureKind::SHOES)
  for monstruo in prueba
    puts monstruo
  end
  
    puts "\nLos monstruos que su mal rollo supone pérdida de dos manos son: "
  prueba = PierdeTesoro(TreasureKind::BOTHHANDS)
  for monstruo in prueba
    puts monstruo
  end
  
  puts "\nLos monstruos que su buen rollo indica ganancia de nivel superior a 1 son: "
    prueba = LevelSup1()
    for monstruo in prueba
      puts monstruo
    end
